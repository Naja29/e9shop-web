...
const fetchServices = async () => {
  ...
  try {
    console.log('📥 Getting ALL documents from Firebase...');
    const servicesSnapshot = await getDocs(collection(db, 'services'));
    
    console.log('✅ Documents received:', servicesSnapshot.size);
    ...
    console.log('💾 DB services:', dbServices);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-4 text-blue-100">
              Complete Solutions for Sri Lankans in South Korea
            </p>
            <p className="text-lg text-blue-200">
              From financial services to education, we&apos;ve got you covered
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Our team is here to help you find the perfect service for your needs
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="bg-white text-blue-600 px-8 py-4 rounded-lg font-bold hover:bg-blue-50 transition-colors">
                Contact Us
              </Link>
              <a href="tel:010-2735-6199" className="bg-blue-700 text-white px-8 py-4 rounded-lg font-bold hover:bg-blue-800 transition-colors">
                Call: 010-2735-6199
              </a>
            </div>
          </div>
